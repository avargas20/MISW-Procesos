...
* El *Product Owner* (PO) de cada equipo debe participar en la reunión sincrónica de priorización de historias de usuario (HU) con el profesor / tutor.
* De acuerdo a la reunión de priorización ajustar el mapa de historias de usuario y organizar el listado priorizado de HU. Si es necesario partir las historias grandes en historias pequeñas utilizando las técnicas de *slicing* propuestas.
* Cargar las épicas y las HU en el proyecto en Jira. En esta primera versión del PBL, las historias se deben identificar y tener un enunciado de la forma "Como *XXX* quisiera que *YYY* para *ZZZ* y una descripción.
...
---
* URL del proyecto del equipo en Jira.
* URL de la wiki del proyecto en GitHub.
